    ...
    if p.exists():
        ...
        if pid > 0:
            try:
                ...
                if matches_process(pid, exe_path=saved_exe, created_before=saved_created):
                ...
                # On unexpected errors deciding match, be conservative: treat as stale so we can recover
                pass
