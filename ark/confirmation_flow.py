...
class ArkConfirmationController:
    ...
    async def build_payload(
        ...
        *,
        ...
        allow_self_actions = status == "locked" and now < post_start_at
        allow_check_in = show_check_in and allow_self_actions
        ...
        view = ArkConfirmationView(
            ...
            allow_emergency=allow_self_actions,
    ...
    async def create_teams(self, interaction: discord.Interaction) -> None:
        ...
        view = ArkTeamBuilderView(match_id=self.match_id, actor_discord_id=interaction.user.id)
        await interaction.response.send_message("Ark Team Builder", view=view, ephemeral=True)
