...
_CANONICAL_FIELD_CANDIDATES: dict[str, list[str]] = {
    ...
    "AutarchTimes": ["AutarchTimes", "Autarch Times", "Autarch_Times"],  # ADD THIS LINE
...
_INT_KEYS = {
    ...
    "HealedTroopsDelta",
    "Starting_KillPoints",
    "KillPointsDelta",  # moved to INT per request
    "RangedPoints",
    "RangedPointsDelta",
    "AutarchTimes",  # ADD THIS LINE
    "KvKPlayed",
    "MostKvKKill",
    "MostKvKDead",
    "MostKvKHeal",
    ...
    "PreKvk_Rank",
    "Honor_Rank",
    "DKP_SCORE",  # moved to INT per request
    "Power_Delta",  # moved to INT per request
}
...
_FLOAT_KEYS = {
    ...
    "% of Dead Target",
    "% of DKP Target",
    # Power_Delta, DKP_SCORE, KillPointsDelta intentionally NOT here per request
    # KillPointsDelta is treated as int now
}
...
def _map_row(row: pyodbc.Row, cols: list[str]) -> dict[str, Any] | None:
    ...
    mapped = {
        ...
        "Power_Delta": gi("Power_Delta"),  # now coerced to int
        ...
        "Zeroed": gi("Zeroed"),
        "DKP_SCORE": gi("DKP_SCORE"),  # now coerced to int
        ...
        "KillPointsDelta": gi("KillPointsDelta"),  # treated as int per request
        "RangedPoints": gi("RangedPoints"),
        "RangedPointsDelta": gi("RangedPointsDelta"),
        "AutarchTimes": gi("AutarchTimes"),  # ADD THIS LINE
...
def _map_excel_row(
    ...
    mapped = {
        ...
        "KVK_RANK": gi("KVK_RANK"),
        "Starting Power": gi("Starting Power"),
        "Power_Delta": gi("Power_Delta"),  # int
        "Civilization": gs("Civilization"),
        "KvKPlayed": gi("KvKPlayed"),
        "MostKvKKill": gi("MostKvKKill"),
        "MostKvKDead": gi("MostKvKDead"),
        ...
        "HealedTroopsDelta": gi("HealedTroopsDelta"),
        "Starting_KillPoints": gi("Starting_KillPoints"),
        "KillPointsDelta": gi("KillPointsDelta"),  # int
        "RangedPoints": gi("RangedPoints"),
        "RangedPointsDelta": gi("RangedPointsDelta"),
        "AutarchTimes": gi("AutarchTimes"),  # ADD THIS LINE
        "Max_PreKvk_Points": gi("Max_PreKvk_Points"),
