...
async def send_kvk_embed(
    ...
    *,
    ...
    # Include KP and healed_troops in top lists where available
    ...
    if our_king:
        ...
        try:
            k_kp = abbr(our_king.get("kp"))
        except Exception:
            k_kp = str(our_king.get("kp"))
        try:
    ...
    if our_camp:
        ...
        try:
            c_kp = abbr(our_camp.get("kp"))
        except Exception:
            c_kp = str(our_camp.get("kp"))
        try:
