...
KVK_SOURCE_INTAKE_ENABLED = _env_bool("KVK_SOURCE_INTAKE_ENABLED", default=False)
KVK_SOURCE_RECOVERY_ENABLED = _env_bool("KVK_SOURCE_RECOVERY_ENABLED", default=False)
KVK_SOURCE_RECOVERY_INTERVAL_SECONDS = _env_int("KVK_SOURCE_RECOVERY_INTERVAL_SECONDS", default=30)
KVK_SOURCE_RECOVERY_BATCH_SIZE = _env_int("KVK_SOURCE_RECOVERY_BATCH_SIZE", default=8)
# Explicit operator registrations only; never derive destinations from legacy sheets.
KVK_SOURCE_EXPORT_REGISTRATIONS = _get_env("KVK_SOURCE_EXPORT_REGISTRATIONS", default="[]")
EXPORT_COORDINATION_ENABLED = _env_bool("EXPORT_COORDINATION_ENABLED", default=False)
EXPORT_SNAPSHOT_ROOT = _get_env("EXPORT_SNAPSHOT_ROOT")
EXPORT_STORAGE_OWNER = _get_env("EXPORT_STORAGE_OWNER")
KVK_SOURCE_CHANNEL_ID = _env_int("KVK_SOURCE_CHANNEL_ID", default=0)
KVK_SOURCE_UPLOADER_ROLE_IDS = _env_list_int("KVK_SOURCE_UPLOADER_ROLE_IDS", strict=True)
KVK_SOURCE_ARTIFACT_ROOT = _get_env("KVK_SOURCE_ARTIFACT_ROOT")
PREKVK_CHANNEL_ID = _env_int("PREKVK_CHANNEL_ID")
HONOR_CHANNEL_ID = _env_int("HONOR_CHANNEL_ID")
KVK_PLAYER_STATS_CHANNEL_ID = _env_int("KVK_PLAYER_STATS_CHANNEL_ID")
KVK_TARGET_CHANNEL_ID = _env_int("KVK_TARGET_CHANNEL_ID")
KVK_CRYSTALTECH_CHANNEL_ID = _env_int("KVK_CRYSTALTECH_CHANNEL_ID")
STATS_CHANNEL_ID = _env_int("STATS_CHANNEL_ID")
UTC_CLOCK_CHANNEL_ID = _env_int("UTC_CLOCK_CHANNEL_ID")
MEMBER_COUNT_CHANNEL_ID = _env_int("MEMBER_COUNT_CHANNEL_ID")
ACTIVITY_TRACKING_ENABLED = _env_bool("ACTIVITY_TRACKING_ENABLED", default=True)
SERVER_STATUS_ENABLED = _env_bool("SERVER_STATUS_ENABLED", default=True)
ARK_SETUP_CHANNEL_ID = _env_int("ARK_SETUP_CHANNEL_ID")
EXCEL_SOURCE_CHANNEL_ID = _env_int("EXCEL_SOURCE_CHANNEL_ID")
CALENDAR_PINNED_CHANNEL_ID = _env_int("CALENDAR_PINNED_CHANNEL_ID")
MGE_SIGNUP_CHANNEL_ID = _env_int("MGE_SIGNUP_CHANNEL_ID")
MGE_LEADERSHIP_CHANNEL_ID = _env_int("MGE_LEADERSHIP_CHANNEL_ID")
MGE_AWARD_CHANNEL_ID = _env_int("MGE_AWARD_CHANNEL_ID")
MGE_DATA_CHANNEL_ID = _env_int("MGE_DATA_CHANNEL_ID")
MGE_MAIL_DM_USER_IDS = _env_list_int("MGE_MAIL_DM_USER_IDS")
MGE_SIMPLIFIED_FLOW_ENABLED = _env_bool("MGE_SIMPLIFIED_FLOW_ENABLED", default=False)
MGE_SIGNUP_MENTION_ON_CREATE = _env_bool("MGE_SIGNUP_MENTION_ON_CREATE", default=True)
MGE_SIGNUP_MENTION_TEXT = _get_env("MGE_SIGNUP_MENTION_TEXT", "@everyone") or "@everyone"
INVENTORY_UPLOAD_CHANNEL_ID = _env_int("INVENTORY_UPLOAD_CHANNEL_ID")
INVENTORY_ADMIN_DEBUG_CHANNEL_ID = _env_int("INVENTORY_ADMIN_DEBUG_CHANNEL_ID")

OPENAI_API_KEY = _get_env("OPENAI_API_KEY", "")
OPENAI_VISION_MODEL = _get_env("OPENAI_VISION_MODEL", "gpt-4.1-mini") or "gpt-4.1-mini"
OPENAI_VISION_FALLBACK_MODEL = _get_env("OPENAI_VISION_FALLBACK_MODEL", "gpt-5.2") or "gpt-5.2"
OPENAI_VISION_PROMPT_VERSION = (
    _get_env("OPENAI_VISION_PROMPT_VERSION", "inventory_vision_v1") or "inventory_vision_v1"
)
