...
# Wider ordering for sort ranking — covers slots beyond the canonical 16 (Alt 1-5, Farm 1-10)
# so that any non-canonical slot (e.g. Alt 6-10, Farm 11-20) still receives a stable rank.
_PREFERRED_ORDER = (
