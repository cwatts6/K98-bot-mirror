...
def test_parse_speedup_days_rejects_non_integer_float():
    with pytest.raises(ValueError, match=r"whole numbers"):
        parse_speedup_days(505.9)
    with pytest.raises(ValueError, match=r"whole numbers"):
        parse_speedup_days(1.5)
    with pytest.raises(ValueError, match=r"whole numbers"):
        parse_speedup_days(50.5257)
