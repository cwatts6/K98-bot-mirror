...
[source closeout and exact manifest](docs/reference/kvk_source_migration/s11_closeout_and_g4_handoff.md) for delivered behavior, review
...
Next: **G4 plan development only**, using the [new task pack](docs/task_packs/Codex%20Task%20Pack%20-%20KVK%20Source%20Migration%20S11%20G4%20Release%20Planning%20Controlled%20Rollout%20and%20G5%20Acceptance.md) and
[chat starter](docs/task_packs/Codex%20Chat%20Starter%20-%20KVK%20Source%20Migration%20S11%20G4%20Release%20Planning%20Controlled%20Rollout%20and%20G5%20Acceptance.md). Controlled rollout executes only specifically approved
...
Approved S11 runtime composition is locally implemented. The [latest evidence](docs/reference/kvk_source_migration/release_evidence_log.md)
records exact validation/review targets; the [next approval plan](docs/reference/kvk_source_migration/release_readiness_and_rollback.md#s11-local-closure-and-exact-next-approval--2026-09-25)
...
or Bot-machine action follows. See [the current remaining gates](docs/reference/kvk_source_migration/release_readiness_and_rollback.md#s11-composed-runtime-and-remaining-operational-gates--2026-09-24).


## S11 implementation status — 2026-09-24

S11 evidence foundations are being implemented under operator approval; activation remains closed. See [the implementation checkpoint](docs/reference/kvk_source_migration/release_evidence_log.md#s11-approved-implementation-checkpoint--2026-09-24) for completed source work, real remaining gaps and offline-only results.


## S11 trusted-proof design checkpoint — 2026-09-24

The approved design pass now proposes a separately supervised Windows export authority and
additive SQL request/proof evidence. Read the [current decision and approval sequence](docs/reference/kvk_source_migration/release_readiness_and_rollback.md#s11-proof-design-approval-and-rollback--2026-09-24)
before the earlier preparation checkpoint below. No runtime or SQL implementation is authorized
or performed. Earlier statements that no SQL requirement was established describe that earlier
checkpoint; the new proposal establishes a requirement, not an authored or installed delta.


## S11 preparation/design approved — 2026-09-24

The operator approved the initial S11 scope and the proposed **preparation/design-only** next
step. The eight S7 documentation files are updated; no runtime implementation or operational
authority follows. The dated status blocks below remain history.

Start with the [S11 release/approval packet](docs/reference/kvk_source_migration/release_readiness_and_rollback.md#s11-preparation-and-release-approval-packet--2026-09-24),
[composition and proof design](docs/reference/kvk_source_migration/integration_contract_and_consumer_matrix.md#s11-composition-and-trusted-proof-design--2026-09-24),
and [exact proposed implementation manifest](docs/reference/kvk_source_migration/integration_implementation_manifests.md#s11-preparation-and-proposed-implementation-manifests--2026-09-24).
Both factories remain closed. Startup already calls `register_exports(task_monitor)` without a
factory; the missing production composition must not be described as a missing startup hook.
Trusted proof producers and all-writer integration require their own approved implementation.
Installation, provider/Discord execution, deployment and G5 remain unproven and separately gated.

All 57 pending Bot identities remain one mandatory next genuine implementation-PR union,
including the S11 pack/starter, S10D/S10E closeouts and both S10E archive move sides. No standalone
docs PR. SQL's two pending closeout documents remain unchanged and separate. No bot-machine pull,
activation, predecessor rerun or new task is authorized. See the [S11 evidence record](docs/reference/kvk_source_migration/release_evidence_log.md#s11-preparation-evidence--2026-09-24).
...
[task pack](docs/task_packs/Codex%20Task%20Pack%20-%20KVK%20Source%20Migration%20S11%20Controlled%20Release%20and%20Acceptance.md) and [starter](docs/task_packs/Codex%20Chat%20Starter%20-%20KVK%20Source%20Migration%20S11%20Controlled%20Release%20and%20Acceptance.md).
Read the [S10E closeout and exact next-PR manifest](docs/reference/kvk_source_migration/s10e_closeout_and_s11_handoff.md).
...
See [S10D closeout and exact carry-forward manifests](docs/reference/kvk_source_migration/s10d_closeout_and_s10e_handoff.md).

Next: **S10E Export Operator UX and Rollover, initial review/scope only**:
[task pack](docs/task_packs/archive/Codex%20Task%20Pack%20-%20KVK%20Source%20Migration%20S10E%20Export%20Operator%20UX%20and%20Rollover.md) and [starter](docs/task_packs/archive/Codex%20Chat%20Starter%20-%20KVK%20Source%20Migration%20S10E%20Export%20Operator%20UX%20and%20Rollover.md).
...
Use the [S10B task pack](docs/task_packs/archive/Codex%20Task%20Pack%20-%20KVK%20Source%20Migration%20S10B%20Shared%20Export%20Coordination%20Worker%20and%20Durable%20Budget.md) and [starter](docs/task_packs/archive/Codex%20Chat%20Starter%20-%20KVK%20Source%20Migration%20S10B%20Shared%20Export%20Coordination%20Worker%20and%20Durable%20Budget.md).
The [S10A closeout and exact carry-forward manifest](docs/reference/kvk_source_migration/s10a_implementation_and_s10b_handoff.md) controls delivery.
...
Use the [S8C pack](docs/task_packs/archive/Codex%20Task%20Pack%20-%20KVK%20Source%20Migration%20S8C%20Intake%20and%20Admin%20Pairing%20UX.md) and [starter](docs/task_packs/archive/Codex%20Chat%20Starter%20-%20KVK%20Source%20Migration%20S8C%20Intake%20and%20Admin%20Pairing%20UX.md).
...
[Settled requirements](docs/reference/kvk_source_migration/post_s6_integration_requirements.md); [handoff and exact manifest](docs/reference/kvk_source_migration/post_s6_handoff_log.md); [S7 pack](docs/task_packs/archive/Codex%20Task%20Pack%20-%20KVK%20Source%20Migration%20S7%20Integration%20Contract%20and%20Implementation%20Planning.md).
...
[Readiness and rollback](docs/reference/kvk_source_migration/release_readiness_and_rollback.md); [Canonical S6 evidence and delivery](docs/reference/kvk_source_migration/release_evidence_log.md).
