...
See [S8C closeout and exact documentation carry-forward](docs/reference/kvk_source_migration/s8c_closeout_and_s9a_handoff.md) for hashes and evidence distinctions.
Completed S8C pack/starter are archived. **Next implementation: S9A Public Routing and Availability,
initial review/scope only**; use the [pack](docs/task_packs/Codex%20Task%20Pack%20-%20KVK%20Source%20Migration%20S9A%20Public%20Routing%20and%20Availability.md) and [starter](docs/task_packs/Codex%20Chat%20Starter%20-%20KVK%20Source%20Migration%20S9A%20Public%20Routing%20and%20Availability.md).
