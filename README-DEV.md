...
pytest tests/test_calendar_reminder_prefs.py -v 
pytest tests/test_calendar_datetime_utils_usage.py -v
pytest tests/test_calendar_view_pagination.py -v 
pytest tests/test_calendar_engine.py -v 
pytest tests/test_calendar_reminders_dispatch.py -v 
pytest tests/test_calendar_reminders.py -v 
pytest tests/test_calendar_views.py -v 
pytest tests/test_calendar_pinned_embed.py -v
pytest tests/test_calendar_pipeline.py -v 
pytest tests/test_calendar_commands.py -v 
pytest tests/test_event_generator_sourcekind_mapping.py -v 
pytest tests/test_constants.py -v 
pytest tests/test_event_calendar_datetime_utils.py -v
pytest tests/test_calendar_cache_contract.py -v 
pytest tests/test_calendar_schema_contract.py -v 
pytest tests/test_calendar_service.py -v
pytest tests/test_sheets_sync_flow.py -v 
pytest tests/test_sheets_sync_parsers.py -v
pytest tests/test_admin_calendar_commands_task3.py -v 
pytest tests/test_calendar_service_telemetry_task3.py -v 
pytest tests/test_calendar_publish_cache.py -v 
pytest tests/test_event_generator.py -v 
pytest tests/test_calendar_scheduler.py -v 
pytest tests/test_calendar_runtime_cache.py -v
pytest tests/test_calendar_status_embed_task4.py -v

cd C:\discord_file_downloader
.\venv\Scripts\Activate
pytest tests/test_ark_team_balancer.py -v 
pytest tests/test_ark_team_state.py -v 
pytest tests/test_ark_registration_messages.py -v 
pytest tests/test_ark_confirmation_modal.py -v 
pytest tests/test_ark_scheduler_post_start.py -v
pytest tests/test_ark_dal_results.py -v
pytest tests/test_ark_confirmation_view.py -v
pytest tests/test_ark_fuzzy_select_view.py -v 
pytest tests/test_ark_bans_enforcement.py -v
pytest tests/test_ark_ban_utils.py -v
pytest tests/test_ark_ban_commands.py -v
...
pytest tests/test_ark_admin_roster.py -v
