...
pytest -q tests/test_targets_sql_cache_subproc.py
...
pytest -q tests/test_maintenance_orphaning.py
pytest -q tests/test_live_queue_persistence.py
pytest -q tests/test_maintenance_worker_json.py
pytest -q tests/test_processing_pipeline.py

tests/test_processing_pipeline.py
tests/test_live_queue_persistence.py
tests/test_maintenance_worker_json.py
tests/test_maintenance_orphaning.py
