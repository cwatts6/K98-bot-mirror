...
class KvkHistoryPayload:
    ...
    history_summary: dict[str, int | float | None] = field(default_factory=dict)
    history_summary_metrics: dict[str, KvkHistorySummaryMetric] = field(default_factory=dict)
