...
# Use canonical DB helpers for single-row fetches
...
def load_all_weekly(cur) -> dict:
    ...
    return {
        "building": _top3("dbo.vAllianceActivity_WeeklyDelta", "BuildingDelta"),
        "tech": _top3("dbo.vAllianceActivity_WeeklyDelta", "TechDonationDelta"),
