...
SQL_SERVER = _env_required("SQL_SERVER")
SERVER = _env_required("SQL_SERVER")
SQL_DATABASE = _env_required("SQL_DATABASE")
DATABASE = _env_required("SQL_DATABASE")
SQL_USERNAME = _env_required("SQL_USERNAME")
USERNAME = _env_required("SQL_USERNAME")
SQL_PASSWORD = _env_required("SQL_PASSWORD")
PASSWORD = _env_required("SQL_PASSWORD")
...
KVK_BANNER_MAP = {
    ...
    "stratagems": "https://i.ibb.co/sJdSFQN9/stratagems.jpg",
