...
class ArkConfirmationView(LocalTimeToggleView):
    def __init__(
        ...
        *,
        ...
        on_create_teams: Callable[[discord.Interaction], object] | None = None,  # add
    ...
    async def _on_create_teams(self, interaction: discord.Interaction):
        if not self.on_create_teams:
            await self._send_error_message(interaction, "❌ Team builder not configured.")
            return
        try:
