        ...
        *,
        ...
        if res.reminders_embed_status == "sent":
            ...
            label = {
                ...
                "channel_unavailable": f"failed ({res.reminders_embed_status})",
                "permission_failed": f"failed ({res.reminders_embed_status})",
                "post_failed": f"failed ({res.reminders_embed_status})",
