...
from utils import download_attachment, live_queue, update_live_queue_embed
...
def clean_expired_jobs(days=7):
    ...
    live_queue["jobs"] = [
        ...
        if not (
            ...
            and "uploaded" in job
            and datetime.fromisoformat(job["uploaded"]).timestamp() < cutoff
        )
    ]
