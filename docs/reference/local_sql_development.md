...
See [S9A closeout and exact pending documentation manifest](kvk_source_migration/s9a_closeout_and_s9b_handoff.md) for anchors, evidence and delivery rules.
