...
| Player Self-Service | `/me reminders` | `commands/me_cmds.py` | Grouped | Public command-level access | Ephemeral | Standard | Preserve; Phase 4 reminder centre next | Private KVK reminder setup status and transition guidance. |
...
- Player Self-Service Command Centre Phase 2 added `/me` with five private subcommands:
  ...
  with confirmation and was smoke tested successfully on 2026-06-22. Phase 4 will turn
