...
| Player/KVK | `/kvk history` | `commands/kvk_cmds.py` | Grouped | KVK stats channel decorator | User-selectable | Standard | Modern Phase 4B card journey; legacy `/mykvkhistory` remains live | Player KVK history card journey with CSV export. |
