...
| Ark reminder system | ark/ark_scheduler.py, ark/reminder_state.py, ark/reminder_types.py, ark/reminder_prefs.py | Poll-loop driven; deduplication via JSON state; DMs respect per-user opt-out prefs |
---
