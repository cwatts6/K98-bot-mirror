...
Phase 8 must preserve every target command's existing privacy, authorization, file-delivery,
channel, and permission rules. Do not add direct export buttons until the service-backed path is
