...
- Status: `delivered in production PR #480 and smoke tested successfully`
...
- Delivered in production PR #480.
- Smoke tested successfully by the operator on 2026-06-26.
- Final smoke feedback confirmed all cards and commands worked; the only polish item was an
  Inventory card alignment issue where the Materials row overlapped the action text, which was
