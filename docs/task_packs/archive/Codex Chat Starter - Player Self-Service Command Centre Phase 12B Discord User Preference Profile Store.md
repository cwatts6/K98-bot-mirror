...
Status: historical starter used for Phase 12B. Phase 12B is complete in mirror PR #177, SQL PR
#20, and production PR #485, and was smoke tested successfully by the operator on 2026-06-27.
Use the Phase 13 starter for the next Player Self-Service Command Centre slice.
...
Delivered smoke confirmed dropdown-based Manage Profile controls, SQL-backed persistence,
generated card refresh, and in-place replacement of the private Manage Profile child window.
