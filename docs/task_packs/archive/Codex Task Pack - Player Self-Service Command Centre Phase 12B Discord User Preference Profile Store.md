...
- Status: `complete; delivered in mirror PR #177, SQL PR #20, and production PR #485; smoke tested successfully on 2026-06-27`
...
- Add guided Manage controls to add, update, and remove delivered values.
...
Smoke test completed successfully on 2026-06-27:
...
- Timezone, location country, and preferred language use dropdowns so players do not need to know
  IANA timezone keys, country codes, or language tags.
- The main generated card refreshes after profile updates.
- The private Manage Profile child window is replaced after save/clear actions; repeated updates
  do not create duplicate child windows.
- Invalid values are rejected privately with actionable copy where service validation is reached.
