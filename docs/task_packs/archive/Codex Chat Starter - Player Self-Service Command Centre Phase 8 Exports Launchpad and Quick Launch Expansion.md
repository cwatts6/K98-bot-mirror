...
Status: historical starter. Phase 8 is delivered in production PR #478 and smoke tested
successfully on 2026-06-25. Use
`docs/task_packs/Codex Chat Starter - Player Self-Service Command Centre Phase 9 Quick Launch Expansion and Legacy Export Rollout.md`
