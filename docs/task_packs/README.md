...
See [S9A closeout and exact pending documentation manifest](../reference/kvk_source_migration/s9a_closeout_and_s9b_handoff.md) for anchors, evidence and delivery rules.
The completed S9A pack/starter are archived. Next is **S9B Stats/Target Card Context and Grouped
Admin Source Dispatch, initial review/scope only**: [task pack](Codex%20Task%20Pack%20-%20KVK%20Source%20Migration%20S9B%20Stats%20Target%20Card%20Context%20and%20Admin%20Dispatch.md) and [starter](Codex%20Chat%20Starter%20-%20KVK%20Source%20Migration%20S9B%20Stats%20Target%20Card%20Context%20and%20Admin%20Dispatch.md).
...
## S8B closeout / S8C active navigation
