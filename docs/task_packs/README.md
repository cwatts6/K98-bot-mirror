...
- Active Phase 13 files:
  - `Codex Task Pack - Player Self-Service Command Centre Phase 13 Legacy Redirect Planning.md`
  - `Codex Chat Starter - Player Self-Service Command Centre Phase 13 Legacy Redirect Planning.md`
- Active programme file:
  - `Player Self-Service Command Centre - Programme Pack.md`
- Completed Phase 1 through Phase 12B execution records are archived under `archive/`.
...
Player Self-Service Command Centre Phase 13 Legacy Redirect Planning is the next planned programme
slice, with the task pack and starter prepared for audit/scope. KVK final removal of temporary
