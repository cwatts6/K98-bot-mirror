...
- The active next phase is Phase 10 Inventory Summary Card.
- Active Phase 10 files:
  - `Codex Task Pack - Player Self-Service Command Centre Phase 10 Inventory Summary Card.md`
  - `Codex Chat Starter - Player Self-Service Command Centre Phase 10 Inventory Summary Card.md`
- Active programme file:
  - `Player Self-Service Command Centre - Programme Pack.md`
- Completed Phase 1 through Phase 9 execution records are archived under `archive/`.
