...
Status: ready for use after the operator merges mirror PR #253 and production PR #560 or explicitly
approves an equivalent Phase 2B-containing base. This starts review/scope only.
