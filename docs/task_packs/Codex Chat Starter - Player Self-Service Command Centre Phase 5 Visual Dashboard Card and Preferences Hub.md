...
Status: historical starter. Phase 5 is complete; use
`docs/task_packs/Codex Chat Starter - Player Self-Service Command Centre Phase 6 Guided Management Cards and Workflow Simplification.md`
