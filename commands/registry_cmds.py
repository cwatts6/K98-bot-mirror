...
def register_registry(bot: ext_commands.Bot) -> None:
    ...
    @bot.slash_command(
        ...
        description="Deprecated: use /me accounts to link or replace governors.",
        guild_ids=[GUILD_ID],
    )
    @versioned("v1.06")
    @safe_command
    ...
    @bot.slash_command(
        ...
        description="Deprecated: use /me accounts to change linked governors.",
        guild_ids=[GUILD_ID],
    )
    @versioned("v1.06")
    @safe_command
    ...
    @bot.slash_command(
        ...
        description="Deprecated: use /me accounts to view linked governors.",
        guild_ids=[GUILD_ID],
    )
    @versioned("v1.09")
    @safe_command
