...
def register_subscriptions(bot: ext_commands.Bot) -> None:
    ...
    @bot.slash_command(
        name="subscribe",
        description="Deprecated: use /me reminders to manage reminder subscriptions.",
        guild_ids=[GUILD_ID],
    )
    @versioned("v1.11")
    @safe_command
    ...
    @bot.slash_command(
        ...
        description="Deprecated: use /me reminders to update reminder preferences.",
        guild_ids=[GUILD_ID],
    )
    @versioned("v1.09")
    @safe_command
    ...
    @bot.slash_command(
        name="unsubscribe",
        description="Deprecated: use /me reminders to turn reminder DMs off.",
        guild_ids=[GUILD_ID],
    )
    @versioned("v1.04")
    @safe_command
